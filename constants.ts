...
export const KINGLEY_MINT_ADDRESS = "KNGYekiS3d3GtnGfP22f4J2aUvE12vA2s6a4J";
export const GAS_STIPEND_SOL = 0.01;
export const WELCOME_KINGLEY_AMOUNT = 1000;
export const LIVE_EMBED_URL = "https://www.youtube.com/embed/live_stream?channel=UC-lHJZR3Gqxm24_Vd_AJ5Yw&autoplay=1&mute=1";
export const ONBOARDING_VIDEO_URL = "https://www.youtube.com/embed/dQw4w9WgXcQ"; // Placeholder video

export const COPY = {
    WELCOME_MESSAGE: "You’ve just been given a random act of kindness. This is proof that goodness is real. Claim your gift and pass it forward.",
    ONBOARDING_PROMPT: "Your turn. Do something kind. Give some tokens. Spread the movement.",
    MISSION_CARD_TITLE: "Your First Mission",
